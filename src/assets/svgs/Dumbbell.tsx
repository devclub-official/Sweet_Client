...
interface DumbbellProps extends SvgOptions {
  fill?: string,
}

export const Dumbbell = (props: DumbbellProps) => {
  const { width = '36', height = '23', color = 'white', fill = undefined } = props;
  return (
    <Svg width={width} height={height} fill={fill} viewBox="0 0 36 23">
      <Path
        stroke={color}
